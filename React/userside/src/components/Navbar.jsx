    ...
    <header className="relative flex flex-wrap sm:justify-start sm:flex-nowrap w-full shadow-md bg-white text-sm py-3">
      <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between">
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-house"><path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"/>
          <path d="M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg> 
            <Link className="font-medium text-blue-500 focus:outline-none" to="/" aria-current="page">Home</Link>
            </div>
          <div className=' flex flex-row gap-2'> 
          ...
          <path d="M21.801 10A10 10 0 1 1 17 3.335"/><path d="m9 11 3 3L22 4"/></svg>
            <Link className="font-medium text-gray-600 hover:text-gray-400 focus:outline-none focus:text-gray-400" to="/verification">Verify</Link>
            </div>
           <div className=' flex flex-row gap-2'> 
            ...
            <Link className="font-medium text-gray-600 hover:text-gray-400 focus:outline-none focus:text-gray-400" to="/blog">View uploaded</Link>
          </div>
          </div>
        </div>
      </nav>
